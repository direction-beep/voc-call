// Script de tracking Google Analytics 4 pour VOC-Call
// Intégration complète avec événements personnalisés et objectifs

// Configuration Google Analytics 4
const GA4_CONFIG = {
    measurementId: 'G-XXXXXXXXXX', // À remplacer par votre ID de propriété GA4
...
function initGoogleAnalytics() {
    ...
    console.log('Google Analytics 4 initialisé pour VOC-Call');
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Analytics tracking initialisé pour VOC-Call');
});
